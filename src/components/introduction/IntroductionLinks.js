    ...
    return (
      <div className="reference-container">
        <div className="link-container">
          <a href="https://github.com/mankaine" target="_blank">
        ...
        <div className="link-container">
          <a href="https://www.linkedin.com/in/williamthankhaine/" target="_blank">
        ...
        <div className="link-container">
          <a href="mailto:williamkhaine@gmail.com" target="_blank">
        ...
        <div className="link-container">
          <a href="./images/WilliamThanKhaineResume.pdf" target="_blank">
