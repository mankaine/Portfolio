  ...
  render() {
    return (
      <div className="intro-text-container">
        ...
        <p>By writing and designing programs, I hope to make technology more empowering and intuitive. Most projects have been on the front end, but I'm excited with working on full stack applications.</p>
